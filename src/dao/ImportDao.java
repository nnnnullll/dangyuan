...
public class ImportDao {
    public Member ImportMember(String cyid, String mm, String zid,
        ...
        String sql = "insert into member(cyid,mm,zid,zbid,dyid,xm,sjh,sfz,zb,csrq,jg,sqrq,jjrq,fzrq,ybrq,zsrq) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        try {
            ...
            pstmt.setString(9,zb);pstmt.setString(10,csrq);
            ...
            member=new Member(cyid1,mm,zid1,zbid1,dyid1,xm,sjh,sfz,zb,csrq,jg,sqrq,jjrq,fzrq,ybrq,zsrq);
            pstmt.executeUpdate();
